...
@IBDesignable open class HoshiTextField: TextFieldEffects {
    ...
    */
    ...
    open var fontScale: (active: CGFloat, inactive: CGFloat) = (active: 0.75, inactive: 1.0) {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    fileprivate func placeholderFontFromFont(_ font: UIFont?, active: Bool) -> UIFont? {
        if let font = font {
    ...
    fileprivate func layoutPlaceholderInTextRect(active: Bool = false) {
